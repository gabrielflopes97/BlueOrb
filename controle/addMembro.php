				...
				<div id="content">
					<?php
						if ($_POST['txtNome']) {
							...
							$destino = '../img/equipe/' . $novoNome;
							if (@move_uploaded_file($arquivo_tmp, $destino)) {
								$controle->addMembro($_POST['txtNome'], $_POST['txtCargo'], $_POST['txtLink'], $novoNome);
							}
						}
					?>

					<form action="addMembro.php" method="post" enctype="multipart/form-data">
						
						Nome: <br />
						<input type="text" name="txtNome" required /> <br />
						Cargo: <br />
						<input type="text" name="txtCargo" required /> <br />
						Portfolio: <br />
